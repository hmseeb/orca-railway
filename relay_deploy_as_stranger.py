#!/usr/bin/env python3
"""Deploy Orca ADE (w/ Relay) into a fresh project exactly as the Deploy button
does, answering the password prompt. Password goes to the Keychain.
Usage: relay_deploy_as_stranger.py <workspaceId> <keychain-service> [project-name]"""
...
import rw  # noqa: E402
from relay_template import TEMPLATE_ID, RELAY
...
cfg["services"][RELAY]["variables"]["ORCA_PASSWORD"]["value"] = password
